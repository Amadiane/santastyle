      ...
      <div style={{
        ...
        <Link to="/dashboardAdmin" style={{ textDecoration: "none", flexShrink: 0 }}>
          <div style={{
            ...
            boxShadow: `0 2px 10px ${tokens.gold}40`,
          }}>
        ...
        {!collapsed && (
          <div style={{ flex: 1, overflow: "hidden" }}>
            ...
            <div style={{ fontSize: "11px", color: tokens.textDim }}>Administration</div>
          </div>
        )}
      ...
      <nav style={{ flex: 1, overflowY: "auto", overflowX: "hidden", padding: "12px 8px", display: "flex", flexDirection: "column", gap: "4px" }}>
        {navSections.map((section, si) => (
          <div key={si} style={{ marginBottom: "8px" }}>
            ...
            {!collapsed && (
              <div style={{
                fontSize: "10px", fontWeight: "800", color: tokens.textDim,
      ...
      <div style={{
        ...
        <div style={{
          ...
          {!collapsed && (
            <div style={{ flex: 1, minWidth: 0 }}>
              <div style={{ fontSize: "13px", fontWeight: "700", color: tokens.text, overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>Admin</div>
        ...
        <button onClick={handleLogout} title="Déconnexion"
          style={{
            ...
            gap: "8px", padding: collapsed ? "9px 0" : "9px 12px",
            borderRadius: "10px", border: `1px solid ${tokens.danger}40`,
            background: `${tokens.danger}12`,
            color: tokens.danger, fontSize: "13px", fontWeight: "600",
