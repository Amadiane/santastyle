        ...
        <div style={{
          ...
          <div style={{ textAlign: "center", marginBottom: "32px" }}>
            <div style={{
              ...
              boxShadow: `0 4px 20px ${SS.gold}40`,
              marginBottom: "16px",
            }}>
          ...
          {error && (
            <div style={{
              ...
              background: SS.dangerBg, border: `1px solid ${SS.danger}40`,
              borderRadius: "10px", color: SS.danger, fontSize: "13px",
          ...
          <form onSubmit={handleLogin} style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
            ...
            <div>
              ...
              <div style={{
                ...
                border: `1px solid ${focusUser ? SS.gold : SS.border}`,
                borderRadius: "10px",
                boxShadow: focusUser ? `0 0 0 3px ${SS.gold}20` : "none",
                transition: "all 0.2s",
              }}>
                ...
                <input
                  ...
                  style={{
                    ...
                    color: SS.text, fontSize: "14px", padding: "12px 0",
                  }}
                />
              </div>
            </div>
            ...
            <div>
              ...
              <div style={{
                ...
                padding: "0 14px",
                background: SS.surface,
                border: `1px solid ${focusPass ? SS.gold : SS.border}`,
                borderRadius: "10px",
                boxShadow: focusPass ? `0 0 0 3px ${SS.gold}20` : "none",
                transition: "all 0.2s",
              }}>
          ...
          <div style={{ marginTop: "24px", paddingTop: "20px", borderTop: `1px solid ${SS.border}`, textAlign: "center" }}>
            ...
            <div style={{ fontSize: "11px", color: SS.textDim, marginTop: "4px", display: "flex", alignItems: "center", justifyContent: "center", gap: "4px" }}>
              <Shield size={11} color={SS.gold} />
              Santa'Style — Système de gestion
            </div>
          </div>
        </div>
